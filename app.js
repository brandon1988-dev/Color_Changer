const colors = ["AliceBlue", "AntiqueWhite", "Aqua","AquaMarine", "Azure", "Azure", "Beige", "Bisque", "Black", "BlanchedAlmond",
                ...
                "DarkOliveGreen", "DarkOrange", "DarkOrchid", "DarkRed", "DarkSalmon", "DarkSeaGreen", "DarkSlateBlue", "DarkSlateGray", "DarkSlateGray","DarkTurquoise",
                "DarkViolet", "DeepPink", "DeepSkyBlue", "DimGray", "DimGrey", "DodgerBlue", "FireBrick", "FloralWhite", "ForestGreen", "Fuchsia",
                "Gainsboro", "GoldenRod", "Gray", "Grey", "Green", "GreenYellow", "HoneyDew", "HotPink", "IndianRed", "Indigo",
                "Ivory", "Khaki", "Lavender", "LavenderBush", "LawnGreen", "LemonChiffon", "LightBlue", "LightCoral", "LightCyan", "LightGoldenRodYellow",
...
btn.addEventListener("click", function () {
    // get random number between 0 - 140
